  ...
  <div style="background:var(--dark);padding:5rem 0 4rem;border-bottom:1px solid rgba(255,255,255,0.06);position:relative;overflow:hidden">
    ...
    <div class="container" style="position:relative;z-index:1">
      <div style="max-width:680px">
        <span class="label reveal"><?php echo getSetting('nosotros_label', 'Nuestra historia'); ?></span>
        <h1 style="margin:1rem 0 1.5rem" class="reveal delay-1"><?php echo getSetting('nosotros_title', 'Arte que nace desde<br><span class="accent">el amor y la resiliencia</span>'); ?></h1>
        <p style="color:var(--mid);font-size:1.05rem;line-height:1.9;max-width:560px" class="reveal delay-2">
          <?php echo getSetting('nosotros_hero_desc', 'Katy & Woof es más que un emprendimiento. Es una historia de vida, de superación y de gratitud hacia los animales que nos acompañan en los momentos más difíciles.'); ?>
        </p>
      </div>
    </div>
  </div>
        ...
        <div>
          ...
          <div style="display:flex;flex-direction:column;gap:1.2rem">
            <p class="reveal delay-2" style="line-height:1.9;color:var(--mid)">
              <?php echo getSetting('our_history_detailed_p1', 'KATY & WOOF nace desde una historia de amor, resiliencia y conexión con los animales. Durante una etapa muy difícil de mi vida enfrenté <strong style="color:var(--white)">dos cánceres</strong>. En ese proceso, mis mascotas estuvieron siempre a mi lado, acompañándome con su cariño incondicional y convirtiéndose en verdaderos asistentes emocionales que me ayudaron a seguir adelante.'); ?>
            </p>
            <p class="reveal delay-3" style="line-height:1.9;color:var(--mid)">
              <?php echo getSetting('our_history_detailed_p2', 'A partir de esa experiencia nació la necesidad de agradecer y honrar el amor de los animales a través del arte. Así comencé a pintar <strong style="color:var(--white)">retratos coloridos de mascotas</strong>, capturando su esencia, su mirada y la alegría que entregan a nuestras vidas.'); ?>
            </p>
            <p class="reveal delay-4" style="line-height:1.9;color:var(--mid)">
              <?php echo getSetting('our_history_detailed_p3', 'Con el tiempo, este arte se transformó en KATY & WOOF, un emprendimiento donde los retratos también pueden convertirse en poleras, polerones, mochilas, zapatillas y otros productos personalizados. Además, mi trabajo artístico también incluye <strong style="color:var(--white)">animales autóctonos de Chile</strong>, como una forma de rescatar, valorar y difundir nuestra cultura y la belleza de la fauna de nuestro país.'); ?>
            </p>
          </div>
        </div>
        <div class="reveal delay-2">
          <div style="display:grid;grid-template-columns:1fr 1fr;gap:1rem">
            <div class="card" style="aspect-ratio:3/4;background:var(--dark2);display:flex;align-items:center;justify-content:center;color:var(--gray2);grid-row:span 2;overflow:hidden">
              <img src="<?php echo getSetting('nosotros_image', $base.'/img/placeholder.svg'); ?>" style="width:100%;height:100%;object-fit:cover" alt="Katherine">
            </div>
          ...
          <div class="glass" style="padding:1.5rem;margin-top:1rem;border-color:rgba(232,57,154,0.15)">
            ...
            <div style="font-size:1.1rem;font-weight:700"><?php echo getSetting('nosotros_founder_name', 'Katherine Rojas Labrín'); ?></div>
            <div style="font-size:0.82rem;color:var(--mid);margin-top:0.2rem"><?php echo getSetting('nosotros_founder_details', 'Artista · La Serena, Chile'); ?></div>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="grid-2" style="gap:2rem">
        <div class="glass reveal" style="padding:2.5rem;border-color:rgba(232,57,154,0.15)">
          ...
          <p style="color:var(--light);line-height:1.9;font-size:0.95rem">
            <?php echo getSetting('nosotros_mision', 'Crear arte que celebre el vínculo entre las personas y los animales, transformando retratos en recuerdos únicos llenos de color, emoción y significado.'); ?>
          </p>
        </div>
        <div class="glass reveal delay-1" style="padding:2.5rem">
          ...
          <p style="color:var(--light);line-height:1.9;font-size:0.95rem">
            <?php echo getSetting('nosotros_vision', 'Ser una marca reconocida por convertir el amor por los animales en arte con identidad, promoviendo también el valor de la fauna chilena y nuestra cultura.'); ?>
          </p>
        </div>
      </div>
