  ...
  <div class="container">
    <div class="header-inner">
      <a href="<?php echo $base; ?>/" class="logo">
        <img src="<?php echo getSetting('site_logo', $base.'/assets/logos/Logo_KW_Horizontal.png'); ?>" alt="Katy &amp; Woof" style="height:38px;width:auto;object-fit:contain" fetchpriority="high">
      </a>
