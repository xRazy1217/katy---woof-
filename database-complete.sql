...
CREATE TABLE IF NOT EXISTS `products` (
  ...
  `stock_status` enum('instock','outofstock','onbackorder') COLLATE utf8mb4_unicode_ci DEFAULT 'instock',
  ...
  `status` enum('publish','draft','trash') COLLATE utf8mb4_unicode_ci DEFAULT 'publish',
  `product_type` enum('service','physical') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'physical',
  `requires_shipping` tinyint(1) NOT NULL DEFAULT '1',
  `service_category` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `service_duration_minutes` int DEFAULT NULL,
  `service_mode` enum('online','presencial','mixto') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `orders` (
  ...
  `status` enum('pending','processing','shipped','completed','cancelled','refunded','failed') COLLATE utf8mb4_unicode_ci DEFAULT 'pending',
  `currency` varchar(3) COLLATE utf8mb4_unicode_ci DEFAULT 'CLP',
  `subtotal` decimal(10,2) NOT NULL,
  `tax_total` decimal(10,2) DEFAULT '0.00',
  `shipping_total` decimal(10,2) DEFAULT '0.00',
  `discount_total` decimal(10,2) DEFAULT '0.00',
  `total` decimal(10,2) NOT NULL,
  `payment_method` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT 'flow',
  `payment_status` enum('pending','paid','failed','refunded','cancelled') COLLATE utf8mb4_unicode_ci DEFAULT 'pending',
  `transaction_id` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `flow_order_id` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `order_status_history` (
  `id` int NOT NULL AUTO_INCREMENT,
  `order_id` int NOT NULL,
  `old_status` enum('pending','processing','shipped','completed','cancelled','refunded','failed') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `new_status` enum('pending','processing','shipped','completed','cancelled','refunded','failed') COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `list_items` (
  `id` int NOT NULL AUTO_INCREMENT,
  `list_key` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `shipping_methods` (
  ...
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `description` text COLLATE utf8mb4_unicode_ci,
  `method_type` enum('flat_rate','free_shipping','local_pickup') COLLATE utf8mb4_unicode_ci DEFAULT 'flat_rate',
...
CREATE TABLE IF NOT EXISTS `user_addresses` (
  ...
  `country` varchar(2) COLLATE utf8mb4_unicode_ci DEFAULT 'CL',
...
-- http://localhost/katy-&-woof/katy-woof/admin/
-- Contraseña: Asesor25
-- ============================================
